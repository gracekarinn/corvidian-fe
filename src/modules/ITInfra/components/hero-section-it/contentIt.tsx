          ...
          {infrastructureExpanded && (
            <div className="mt-2 flex flex-col">
              ...
              {infrastructureFAQExpanded && (
                <div className="bg-[#C5CED5] shadow-xl w-[calc(100%-40px)] lg:w-[1110px] ml-[40px] lg:ml-[105px] p-4 lg:p-6 transition-all duration-300 ease-in-out">
                  <div className="mb-4">
                    <h3 className="font-bold text-[12px] lg:text-sm mb-2">Berapa lama waktu yang dibutuhkan untuk setup infrastruktur IT?</h3>
                    <p className="text-[12px] lg:text-sm">Waktu setup bervariasi tergantung pada kompleksitas dan skala proyek, biasanya antara 2-6 minggu.</p>
                  </div>
                  <div className="mb-4">
                    <h3 className="font-bold text-[12px] lg:text-sm mb-2">Apakah layanan maintenance termasuk dalam paket?</h3>
          ...
          {securityExpanded && (
            <div className="mt-2 flex flex-col">
              ...
              {securityFAQExpanded && (
                <div className="bg-[#C5CED5] shadow-xl w-[calc(100%-40px)] lg:w-[1110px] ml-[40px] lg:ml-[105px] p-4 lg:p-6 transition-all duration-300 ease-in-out">
                  <div className="mb-4">
                    <h3 className="font-bold text-[12px] lg:text-sm mb-2">Seberapa sering audit keamanan perlu dilakukan?</h3>
                    <p className="text-[12px] lg:text-sm">Kami merekomendasikan audit keamanan komprehensif setidaknya setiap 6 bulan, dengan pemantauan berkelanjutan.</p>
                  </div>
                  <div className="mb-4">
                    <h3 className="font-bold text-[12px] lg:text-sm mb-2">Apa standar keamanan yang Anda terapkan?</h3>
          ...
          {operationsExpanded && (
            <div className="mt-2 flex flex-col">
              ...
              {operationsFAQExpanded && (
                <div className="bg-[#C5CED5] shadow-xl w-[calc(100%-40px)] lg:w-[1110px] ml-[40px] lg:ml-[105px] p-4 lg:p-6 transition-all duration-300 ease-in-out">
                  <div className="mb-4">
                    <h3 className="font-bold text-[12px] lg:text-sm mb-2">Bagaimana cara mengakses dukungan teknis?</h3>
                    <p className="text-[12px] lg:text-sm">Dukungan tersedia melalui telepon, email, dan portal web 24/7 untuk klien dengan kontrak dukungan.</p>
                  </div>
                  <div className="mb-4">
                    <h3 className="font-bold text-[12px] lg:text-sm mb-2">Berapa lama waktu respon untuk masalah kritis?</h3>
